    ...
    return (
        <div className="Como_funciona_usuario">
            ...
            <div className="Como_funcionaU_header">
                <img className="Como_funcionaU_logo_header" src="https://raw.githubusercontent.com/EduardoOliveiraDev/ImagesVisuMEI/adb35ab17d89a66adb35775990aa8aeb1e88c9a4/Como%20Funciona/Logotipo.svg" />
            ...
            <div className="Como_funcionaU_topo">
                ...
                <div className="Como_funcionaU_topo_align">
                    <div className="Como_funcionaU_topo_botao">
                        <p>Estou em busca de um produto ou serviço</p>
                    </div>
                    <p className="Como_funcionaU_text2">Quero anunciar um produto ou serviço</p>
                </div>
            </div>
